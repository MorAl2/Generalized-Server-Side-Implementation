...
//                vector<State<string> *> *raw5 = new vector<State<string> *>();
//
//
//                auto temp = new State<string>("4", 4);
//                int x = 0, y = -1;
...
//
//                temp = new State<string>("9", 9);
//                temp->setPosition(4, 1);
//                raw5->push_back(temp);
//
//                temp = new State<string>("8", 8);
//                temp->setPosition(4, 2);
//                raw5->push_back(temp);
//
//                temp = new State<string>("9", 9);
//                temp->setPosition(4, 3);
//                raw5->push_back(temp);
//
//                temp = new State<string>("3", 3);
//                temp->setPosition(4, 4);
//                raw5->push_back(temp);
//
//
//                mat->addline(raw1);
